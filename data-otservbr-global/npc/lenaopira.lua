...
npcConfig.shop = {	
	...
	{ itemName = "collar of blue plasma", clientId = 23542, buy = 1 },
	{ itemName = "collar of green plasma", clientId = 23543, buy = 1 },
	{ itemName = "collar of red plasma", clientId = 23544, buy = 1 },
	{ itemName = "terra amulet", clientId = 814, buy = 1 },
	{ itemName = "life ring", clientId = 3052, buy = 1 },
	{ itemName = "might ring", clientId = 3048, buy = 1 },
	{ itemName = "ring of blue plasma", clientId = 23529, buy = 1 },
	{ itemName = "ring of green plasma", clientId = 23531, buy = 1 },
	{ itemName = "ring of healing", clientId = 3098, buy = 1 },
	{ itemName = "prismatic ring", clientId = 16114, buy = 1 },
	{ itemName = "ring of red plasma", clientId = 23533, buy = 1 },
	{ itemName = "stealth ring", clientId = 3049, buy = 1 },
	{ itemName = "time ring", clientId = 3053, buy = 1 },
	{ itemName = "dwarven ring", clientId = 3097, buy = 1 },
	{ itemName = "energy ring", clientId = 3051, buy = 1 },
	...
	{ itemName = "sword ring", clientId = 3091, buy = 1 },
